...
<html>
    ...
    <body>
        ...
        {//Se non � la prima volta che accedo ad una pagina
            ...
            {//Se la sessione non � impostata(come ad esempio quando � la prima volta che accedo alla pagina),imposto la sessione al valore corrente del get
                $pag=$_GET['pag'];
                $_SESSION['pag_c']['pag_c']=$pag; 
                //     echo $pag;
            }
        ...
        {//Se il get non � impostato(come ad esempio quando apro per la prima volta gestione case)        
            if (isset($_SESSION['pag_c']['pag_c'])){//Se la sessione � gi� impostata
...
*/
        ...
        if ($result->num_rows !=0)
        {
            ...
            while ($row = $result->fetch_array())
            {
                ...
                if($immagine != null)
                    echo "<td><div ><img src='$immagine[0]' class='modal_image' style='display: block; margin-left: auto; margin-right: auto;width:35px;height:30px'  ></div></td> ";//$immagine � un array che conterr� una sola stringa (ad esempio: immagini/1.png) al posto numero 0
